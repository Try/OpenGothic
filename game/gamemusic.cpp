...
struct GameMusic::MusicProducer : Tempest::SoundProducer {
  ...
  void updateTheme() {
    phoenix::daedalus::c_music_theme       theme;
  ...
  bool setMusic(const phoenix::daedalus::c_music_theme &theme, Tags tags){
    std::lock_guard<std::mutex> guard(pendingSync);
  ...
  bool                                   reloadTheme=false;
  phoenix::daedalus::c_music_theme       pendingMusic;
...
struct GameMusic::Impl final {
  ...
  void setMusic(const phoenix::daedalus::c_music_theme &theme, Tags tags) {
...
void GameMusic::setMusic(const phoenix::daedalus::c_music_theme &theme, Tags tags) {
