...
* ![!](ni.png) func int Npc_HasEquippedWeapon(var C_Npc npc)
  ...
  Same as:
  Npc_HasEquippedMeleeWeapon(npc) || Npc_HasEquippedRangedWeapon(npc)
  Not implemented.
...
* ![!](ni.png) func void TA_BeginOverlay(var C_Npc self)
  Not implemented.

* ![!](ni.png) func void TA_EndOverlay(var C_Npc self)
  Not implemented.

* ![!](ni.png) func void TA_RemoveOverlay(var C_Npc self)
  Not implemented.
